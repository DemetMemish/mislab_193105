...
import 'package:mislab_193105/login_screen.dart';
import 'package:mislab_193105/regiter_screen.dart';
import 'package:mislab_193105/slot_view.dart';
...
class _MyAppState extends State<MyAppClass> {
  ...
  final vremeController = TextEditingController();
        ...
        _store
          ...
          for (var element in value.docs) {
            Map<String, String> slot = {
              ...
              "vreme" : element.data()['Vreme'] as String
            };
            setState(() {
              elements.add(slot);
            });
  ...
  void addSubject() async {
    ...
    String vreme = vremeController.text;
    ...
    setState(() {
      ...
      elements.add({"predmet": name, "termin": termin, "vreme": vreme});
    });
